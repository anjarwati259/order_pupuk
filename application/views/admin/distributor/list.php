        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="#tab_1" data-toggle="tab">Tambah Data Distributor</a></li>
                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        <td><?php echo $no++ ?></td>
                        <td><?php echo $distributor->id_pelanggan ?></td>
                        <td><?php echo $distributor->nama_pelanggan ?></td>
                        <td><?php echo $distributor->no_hp ?></td>
                        <td>
                          <?php echo $distributor->alamat ?>,<br> 
                          <?php echo $distributor->kecamatan ?>, 
                          <?php echo $distributor->kabupaten ?>,<br> 
                          <?php echo $distributor->provinsi ?>
                          
                        </td>
                        <td><?php echo $distributor->nama_komoditi ?></td>
                        <td><?php echo $distributor->pembelian_awal ?></td>
                        <td><?php echo $distributor->tanggal_daftar ?></td>
                        <td>
